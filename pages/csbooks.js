...
export default function Home() {
 ...
 <div> 
    ...
    <br />
      <Head>
        <title>Computer Science books -Decentralized Library </title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
      </Head> 
  <>
          <center>
            <br />
            <h2 className="text-4xl font-bold leading-1 text-black-900 sm:text-5xl hover:opacity-25">Computer Science Book Collections</h2>
            <br />
          </center>
  </>
              ...
              <div key={i} className="-bg-white border shadow rounded-xl overflow-hidden">
                ...
                <div className="p-1">
                  ...
                  <div style={{ height: '100px', overflow: 'hidden' }}>
                    <p className="text-black  pt-2">{nft.description}</p>
                  </div>
                </div>
                <div className="p-2 bg-black">
                  <p className="text-lg mb-1 font-bold text-white text-center">{nft.price} METIS</p>
